...
@section('body')
    ...
    <div class="logo">
        <h1 id="coffee-text">
            @auth
                 <span onclick="document.getElementById('negar-text').click()">Panel</span>
            @else
                <span onclick="document.getElementById('negar-text').click()">Coffee</span>
            @endauth
        </h1>
    </div>
    <nav class="menu">
          ...
          <div class="slide" id="3">
            <div class="content fourth-content">
                <div class="container-fluid" >
                    <div class="row">
                        @auth
                            <button class="btn btn-logout" onclick="window.location = '{{ route('logout') }}';">Logout</button>
                            @can('survey-show')
                                @include('survey.list')
                            @endcan
                        @else
